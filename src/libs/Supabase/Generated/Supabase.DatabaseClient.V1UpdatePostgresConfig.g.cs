...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdatePostgresConfigSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdatePostgresConfigSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdatePostgresConfigSecurityRequirement0,
            };
        partial void PrepareV1UpdatePostgresConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.UpdatePostgresConfigBody request);
        partial void PrepareV1UpdatePostgresConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.UpdatePostgresConfigBody request);
        partial void ProcessV1UpdatePostgresConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpdatePostgresConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await V1UpdatePostgresConfigAsResponseAsync(
                @ref: @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdatePostgresConfigArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdatePostgresConfigSecurityRequirements,
                operationName: "V1UpdatePostgresConfigAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1UpdatePostgresConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdatePostgresConfig",
                                methodName: "V1UpdatePostgresConfigAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/config/database/postgres\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdatePostgresConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdatePostgresConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.PostgresConfigResponse> V1UpdatePostgresConfigAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.UpdatePostgresConfigBody
            {
                EffectiveCacheSize = effectiveCacheSize,
                LogicalDecodingWorkMem = logicalDecodingWorkMem,
                CronLogStatement = cronLogStatement,
                ...
                LogRecoveryConflictWaits = logRecoveryConflictWaits,
                LogReplicationCommands = logReplicationCommands,
                LogStartupProgressInterval = logStartupProgressInterval,
                ...
                WalKeepSize = walKeepSize,
                WalSenderTimeout = walSenderTimeout,
                WorkMem = workMem,
                CheckpointTimeout = checkpointTimeout,
                HotStandbyFeedback = hotStandbyFeedback,
                RestartDatabase = restartDatabase,
            };

            return await V1UpdatePostgresConfigAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
