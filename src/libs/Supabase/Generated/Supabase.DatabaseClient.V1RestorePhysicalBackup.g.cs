...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1RestorePhysicalBackupSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1RestorePhysicalBackupSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1RestorePhysicalBackupSecurityRequirement0,
            };
        partial void PrepareV1RestorePhysicalBackupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.V1RestoreBackupBody request);
        partial void PrepareV1RestorePhysicalBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.V1RestoreBackupBody request);
        partial void ProcessV1RestorePhysicalBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await V1RestorePhysicalBackupAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1RestorePhysicalBackupAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1RestorePhysicalBackupArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1RestorePhysicalBackupSecurityRequirements,
                operationName: "V1RestorePhysicalBackupAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1RestorePhysicalBackupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1RestorePhysicalBackup",
                                methodName: "V1RestorePhysicalBackupAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/database/backups/restore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1RestorePhysicalBackupResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task V1RestorePhysicalBackupAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.V1RestoreBackupBody
            {
                Id = id,
            };

            await V1RestorePhysicalBackupAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
