...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdateNetworkRestrictionsSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdateNetworkRestrictionsSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdateNetworkRestrictionsSecurityRequirement0,
            };
        partial void PrepareV1UpdateNetworkRestrictionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.NetworkRestrictionsRequest request);
        partial void PrepareV1UpdateNetworkRestrictionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.NetworkRestrictionsRequest request);
        partial void ProcessV1UpdateNetworkRestrictionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpdateNetworkRestrictionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdateNetworkRestrictionsArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdateNetworkRestrictionsSecurityRequirements,
                operationName: "V1UpdateNetworkRestrictionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1UpdateNetworkRestrictionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdateNetworkRestrictions",
                                methodName: "V1UpdateNetworkRestrictionsAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/network-restrictions/apply\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdateNetworkRestrictionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdateNetworkRestrictionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.NetworkRestrictionsResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.NetworkRestrictionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.NetworkRestrictionsResponse> V1UpdateNetworkRestrictionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.NetworkRestrictionsRequest
            {
                DbAllowedCidrs = dbAllowedCidrs,
                DbAllowedCidrsV6 = dbAllowedCidrsV6,
            };

            return await V1UpdateNetworkRestrictionsAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
