...
namespace Supabase
{
    public partial class BillingClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1ApplyProjectAddonSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1ApplyProjectAddonSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1ApplyProjectAddonSecurityRequirement0,
            };
        partial void PrepareV1ApplyProjectAddonArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.ApplyProjectAddonBody request);
        partial void PrepareV1ApplyProjectAddonRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.ApplyProjectAddonBody request);
        partial void ProcessV1ApplyProjectAddonResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task V1ApplyProjectAddonAsync(
            string @ref,
        ...
        {
            await V1ApplyProjectAddonAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1ApplyProjectAddonAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1ApplyProjectAddonArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ApplyProjectAddonSecurityRequirements,
                operationName: "V1ApplyProjectAddonAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ApplyProjectAddon",
                                methodName: "V1ApplyProjectAddonAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1ApplyProjectAddonResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task V1ApplyProjectAddonAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.ApplyProjectAddonBody
            {
                AddonVariant = addonVariant,
                AddonType = addonType,
            };

            await V1ApplyProjectAddonAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
