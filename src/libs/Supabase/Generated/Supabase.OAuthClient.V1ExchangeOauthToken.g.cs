...
namespace Supabase
{
    public partial class OAuthClient
    {
...
#endif
        public async global::System.Threading.Tasks.Task<global::Supabase.OAuthTokenResponseOutput> V1ExchangeOauthTokenAsync(

            global::Supabase.OAuthTokenBody request,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1ExchangeOauthTokenAsResponseAsync(
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "SUPABASE_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.OAuthTokenResponseOutput>> V1ExchangeOauthTokenAsResponseAsync(
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.GrantType != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "grant_type",
                                    (request.GrantType).HasValue ? (request.GrantType).GetValueOrDefault().ToValueString() : string.Empty));
                            }
                            if (request.ClientId != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "client_id",
                                    request.ClientId.ToString() ?? string.Empty));
                            }
                            ...
                            if (request.Assertion != default)
                            {
                                __formValues.Add(new global::System.Collections.Generic.KeyValuePair<string, string>(
                                    "assertion",
                                    request.Assertion ?? string.Empty));
                            }
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "V1ExchangeOauthTokenAsync",
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Supabase.OAuthTokenResponseOutput.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Supabase.AutoSDKHttpResponse<global::Supabase.OAuthTokenResponseOutput>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Supabase.OAuthTokenResponseOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
