...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1ModifyDatabaseDiskSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1ModifyDatabaseDiskSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1ModifyDatabaseDiskSecurityRequirement0,
            };
        partial void PrepareV1ModifyDatabaseDiskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.DiskRequestBody request);
        partial void PrepareV1ModifyDatabaseDiskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.DiskRequestBody request);
        partial void ProcessV1ModifyDatabaseDiskResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await V1ModifyDatabaseDiskAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1ModifyDatabaseDiskAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1ModifyDatabaseDiskArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ModifyDatabaseDiskSecurityRequirements,
                operationName: "V1ModifyDatabaseDiskAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1ModifyDatabaseDiskRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ModifyDatabaseDisk",
                                methodName: "V1ModifyDatabaseDiskAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1ModifyDatabaseDiskResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task V1ModifyDatabaseDiskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.DiskRequestBody
            {
                Attributes = attributes,
            };

            await V1ModifyDatabaseDiskAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
