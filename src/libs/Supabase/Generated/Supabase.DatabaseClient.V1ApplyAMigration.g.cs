...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1ApplyAMigrationSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1ApplyAMigrationSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1ApplyAMigrationSecurityRequirement0,
            };
        partial void PrepareV1ApplyAMigrationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            ref string? idempotencyKey,
            global::Supabase.V1CreateMigrationBody request);
        partial void PrepareV1ApplyAMigrationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            string? idempotencyKey,
            global::Supabase.V1CreateMigrationBody request);
        partial void ProcessV1ApplyAMigrationResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task V1ApplyAMigrationAsync(
            string @ref,
        ...
        {
            await V1ApplyAMigrationAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1ApplyAMigrationAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1ApplyAMigrationArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ApplyAMigrationSecurityRequirements,
                operationName: "V1ApplyAMigrationAsync");
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1ApplyAMigrationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ApplyAMigration",
                                methodName: "V1ApplyAMigrationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1ApplyAMigrationResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task V1ApplyAMigrationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.V1CreateMigrationBody
            {
                Query = query,
                Name = name,
                Rollback = rollback,
