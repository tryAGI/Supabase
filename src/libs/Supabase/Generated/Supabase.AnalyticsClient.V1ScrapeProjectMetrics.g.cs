...
namespace Supabase
{
    public partial class AnalyticsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1ScrapeProjectMetricsSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1ScrapeProjectMetricsSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1ScrapeProjectMetricsSecurityRequirement0,
            };
        partial void PrepareV1ScrapeProjectMetricsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref);
        partial void PrepareV1ScrapeProjectMetricsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref);
        partial void ProcessV1ScrapeProjectMetricsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1ScrapeProjectMetricsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> V1ScrapeProjectMetricsAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1ScrapeProjectMetricsAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<string>> V1ScrapeProjectMetricsAsResponseAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1ScrapeProjectMetricsArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ScrapeProjectMetricsSecurityRequirements,
                operationName: "V1ScrapeProjectMetricsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1ScrapeProjectMetricsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ScrapeProjectMetrics",
                                methodName: "V1ScrapeProjectMetricsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1ScrapeProjectMetricsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1ScrapeProjectMetricsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Supabase.AutoSDKHttpResponse<string>(
                                        statusCode: __response.StatusCode,
