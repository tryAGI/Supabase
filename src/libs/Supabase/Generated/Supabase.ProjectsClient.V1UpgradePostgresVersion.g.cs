...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpgradePostgresVersionSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpgradePostgresVersionSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpgradePostgresVersionSecurityRequirement0,
            };
        partial void PrepareV1UpgradePostgresVersionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.UpgradeDatabaseBody request);
        partial void PrepareV1UpgradePostgresVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.UpgradeDatabaseBody request);
        partial void ProcessV1UpgradePostgresVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpgradePostgresVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpgradePostgresVersionArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpgradePostgresVersionSecurityRequirements,
                operationName: "V1UpgradePostgresVersionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1UpgradePostgresVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpgradePostgresVersion",
                                methodName: "V1UpgradePostgresVersionAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/upgrade\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpgradePostgresVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpgradePostgresVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.ProjectUpgradeInitiateResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.ProjectUpgradeInitiateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ProjectUpgradeInitiateResponse> V1UpgradePostgresVersionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.UpgradeDatabaseBody
            {
                TargetVersion = targetVersion,
                ReleaseChannel = releaseChannel,
            };

            return await V1UpgradePostgresVersionAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
