...
namespace Supabase
{
    ...
    public sealed partial class StorageConfigResponseOutputFeaturesIcebergCatalog
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageConfigResponseOutputFeaturesIcebergCatalog" /> class.
        /// </summary>
...
#endif
        public StorageConfigResponseOutputFeaturesIcebergCatalog(
            bool enabled,
            long maxNamespaces,
            long maxTables,
            long maxCatalogs)
