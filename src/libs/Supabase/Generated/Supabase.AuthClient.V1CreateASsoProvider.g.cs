...
namespace Supabase
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1CreateASsoProviderSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1CreateASsoProviderSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1CreateASsoProviderSecurityRequirement0,
            };
        partial void PrepareV1CreateASsoProviderArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.CreateProviderBody request);
        partial void PrepareV1CreateASsoProviderRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.CreateProviderBody request);
        partial void ProcessV1CreateASsoProviderResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1CreateASsoProviderResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1CreateASsoProviderArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1CreateASsoProviderSecurityRequirements,
                operationName: "V1CreateASsoProviderAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CreateASsoProviderRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CreateASsoProvider",
                                methodName: "V1CreateASsoProviderAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CreateASsoProviderResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1CreateASsoProviderResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.CreateProviderResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.CreateProviderResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.CreateProviderResponse> V1CreateASsoProviderAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.CreateProviderBody
            {
                Type = type,
            ...
            return await V1CreateASsoProviderAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
