            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Supabase.SnippetList.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Supabase.SnippetList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
