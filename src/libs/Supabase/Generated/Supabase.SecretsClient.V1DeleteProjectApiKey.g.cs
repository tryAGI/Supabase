...
namespace Supabase
{
    public partial class SecretsClient
    {
        ...
        partial void ProcessV1DeleteProjectApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1DeleteProjectApiKeyAsync(
            string @ref,
            global::System.Guid id,
        ...
        {
            var __response = await V1DeleteProjectApiKeyAsResponseAsync(
                @ref: @ref,
                id: id,
                reveal: reveal,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.ApiKeyResponseOutput>> V1DeleteProjectApiKeyAsResponseAsync(
            string @ref,
            global::System.Guid id,
            string? reveal = default,
            string? wasCompromised = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1DeleteProjectApiKeyArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1DeleteProjectApiKey",
                                methodName: "V1DeleteProjectApiKeyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1DeleteProjectApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1DeleteProjectApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
