...
namespace Supabase
{
    public partial class EdgeFunctionsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1BulkUpdateFunctionsSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1BulkUpdateFunctionsSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1BulkUpdateFunctionsSecurityRequirement0,
            };
        partial void PrepareV1BulkUpdateFunctionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::System.Collections.Generic.IList<global::Supabase.BulkUpdateFunctionBodyItem> request);
        partial void PrepareV1BulkUpdateFunctionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::System.Collections.Generic.IList<global::Supabase.BulkUpdateFunctionBodyItem> request);
        partial void ProcessV1BulkUpdateFunctionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1BulkUpdateFunctionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.BulkUpdateFunctionResponseOutput> V1BulkUpdateFunctionsAsync(
            string @ref,
        ...
        {
            var __response = await V1BulkUpdateFunctionsAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.BulkUpdateFunctionResponseOutput>> V1BulkUpdateFunctionsAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1BulkUpdateFunctionsArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1BulkUpdateFunctionsSecurityRequirements,
                operationName: "V1BulkUpdateFunctionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1BulkUpdateFunctionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1BulkUpdateFunctions",
                                methodName: "V1BulkUpdateFunctionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1BulkUpdateFunctionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1BulkUpdateFunctionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Supabase.BulkUpdateFunctionResponseOutput.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Supabase.AutoSDKHttpResponse<global::Supabase.BulkUpdateFunctionResponseOutput>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Supabase.BulkUpdateFunctionResponseOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
