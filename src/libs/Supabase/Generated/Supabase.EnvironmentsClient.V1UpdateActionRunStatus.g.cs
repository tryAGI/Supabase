...
namespace Supabase
{
    public partial class EnvironmentsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdateActionRunStatusSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdateActionRunStatusSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdateActionRunStatusSecurityRequirement0,
            };
        partial void PrepareV1UpdateActionRunStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            ref string runId,
            global::Supabase.UpdateRunStatusBody request);
        partial void PrepareV1UpdateActionRunStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            string runId,
            global::Supabase.UpdateRunStatusBody request);
        partial void ProcessV1UpdateActionRunStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpdateActionRunStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdateActionRunStatusArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdateActionRunStatusSecurityRequirements,
                operationName: "V1UpdateActionRunStatusAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Supabase.PathBuilder(
                                path: $"/v1/projects/{@ref}/actions/{runId}/status",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdateActionRunStatus",
                                methodName: "V1UpdateActionRunStatusAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/actions/{runId}/status\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdateActionRunStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdateActionRunStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.UpdateRunStatusResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.UpdateRunStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.UpdateRunStatusResponse> V1UpdateActionRunStatusAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.UpdateRunStatusBody
            {
                Clone = clone,
                Pull = pull,
                Health = health,
            ...
            return await V1UpdateActionRunStatusAsync(
                @ref: @ref,
                runId: runId,
                request: __request,
                requestOptions: requestOptions,
