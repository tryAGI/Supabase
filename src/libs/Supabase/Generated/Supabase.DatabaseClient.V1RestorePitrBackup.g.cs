...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1RestorePitrBackupSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1RestorePitrBackupSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1RestorePitrBackupSecurityRequirement0,
            };
        partial void PrepareV1RestorePitrBackupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.V1RestorePitrBody request);
        partial void PrepareV1RestorePitrBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.V1RestorePitrBody request);
        partial void ProcessV1RestorePitrBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task V1RestorePitrBackupAsync(
            string @ref,
        ...
        {
            await V1RestorePitrBackupAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1RestorePitrBackupAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1RestorePitrBackupArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1RestorePitrBackupSecurityRequirements,
                operationName: "V1RestorePitrBackupAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1RestorePitrBackupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1RestorePitrBackup",
                                methodName: "V1RestorePitrBackupAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/database/backups/restore-pitr\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1RestorePitrBackupResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task V1RestorePitrBackupAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.V1RestorePitrBody
            {
                RecoveryTimeTargetUnix = recoveryTimeTargetUnix,
            };

            await V1RestorePitrBackupAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
