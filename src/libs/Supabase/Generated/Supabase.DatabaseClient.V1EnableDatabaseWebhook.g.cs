...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1EnableDatabaseWebhookSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1EnableDatabaseWebhookSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1EnableDatabaseWebhookSecurityRequirement0,
            };
        partial void PrepareV1EnableDatabaseWebhookArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref);
        partial void PrepareV1EnableDatabaseWebhookRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref);
        partial void ProcessV1EnableDatabaseWebhookResponse(
            global::System.Net.Http.HttpClient httpClient,
...
#endif
        public async global::System.Threading.Tasks.Task V1EnableDatabaseWebhookAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await V1EnableDatabaseWebhookAsResponseAsync(
                @ref: @ref,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "SUPABASE_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1EnableDatabaseWebhookAsResponseAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1EnableDatabaseWebhookArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1EnableDatabaseWebhookSecurityRequirements,
                operationName: "V1EnableDatabaseWebhookAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1EnableDatabaseWebhookRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1EnableDatabaseWebhook",
                                methodName: "V1EnableDatabaseWebhookAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/database/webhooks/enable\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1EnableDatabaseWebhookResponse(
                    httpClient: HttpClient,
