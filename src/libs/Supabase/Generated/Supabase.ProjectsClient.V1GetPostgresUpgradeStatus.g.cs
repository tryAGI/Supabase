...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1GetPostgresUpgradeStatusSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1GetPostgresUpgradeStatusSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1GetPostgresUpgradeStatusSecurityRequirement0,
            };
        partial void PrepareV1GetPostgresUpgradeStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            ref string? trackingId);
        partial void PrepareV1GetPostgresUpgradeStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            string? trackingId);
        partial void ProcessV1GetPostgresUpgradeStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1GetPostgresUpgradeStatusResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1GetPostgresUpgradeStatusArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1GetPostgresUpgradeStatusSecurityRequirements,
                operationName: "V1GetPostgresUpgradeStatusAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("tracking_id", trackingId) 
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1GetPostgresUpgradeStatus",
                                methodName: "V1GetPostgresUpgradeStatusAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/upgrade/status\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1GetPostgresUpgradeStatusResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1GetPostgresUpgradeStatusResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.DatabaseUpgradeStatusResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.DatabaseUpgradeStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
