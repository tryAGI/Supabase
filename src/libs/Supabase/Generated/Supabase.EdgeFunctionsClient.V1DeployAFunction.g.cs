...
namespace Supabase
{
    public partial class EdgeFunctionsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("bundleOnly", bundleOnly)
                                ;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Supabase.FunctionDeployBody
            {
                File = new global::System.Collections.Generic.List<byte[]>(),
                Metadata = metadata,
            };
            PrepareArguments(
                client: HttpClient);
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            for (var __iFile = 0; __iFile < file.Count; __iFile++)
                            {
                                var __fileNameFile = fileFileNames != null &&
                                    __iFile < fileFileNames.Count &&
                                    fileFileNames[__iFile] != null
                                    ? fileFileNames[__iFile]
                                    : $"file{__iFile}.bin";
                                var __contentFile = new global::System.Net.Http.StreamContent(file[__iFile]);
                            __contentFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                __fileNameFile is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(__fileNameFile) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
