...
namespace Supabase
{
    public partial class SecretsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdateProjectApiKeySecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdateProjectApiKeySecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdateProjectApiKeySecurityRequirement0,
            };
        partial void PrepareV1UpdateProjectApiKeyArguments(
        ...
        partial void ProcessV1UpdateProjectApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1UpdateProjectApiKeyAsync(
            string @ref,
            global::System.Guid id,
        ...
        {
            var __response = await V1UpdateProjectApiKeyAsResponseAsync(
                @ref: @ref,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.ApiKeyResponseOutput>> V1UpdateProjectApiKeyAsResponseAsync(
            string @ref,
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdateProjectApiKeyArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdateProjectApiKeySecurityRequirements,
                operationName: "V1UpdateProjectApiKeyAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdateProjectApiKey",
                                methodName: "V1UpdateProjectApiKeyAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/api-keys/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdateProjectApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdateProjectApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Supabase.ApiKeyResponseOutput.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Supabase.AutoSDKHttpResponse<global::Supabase.ApiKeyResponseOutput>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Supabase.ApiKeyResponseOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1UpdateProjectApiKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.UpdateApiKeyBody
            {
                Name = name,
            ...
            return await V1UpdateProjectApiKeyAsync(
                @ref: @ref,
                id: id,
                reveal: reveal,
                request: __request,
