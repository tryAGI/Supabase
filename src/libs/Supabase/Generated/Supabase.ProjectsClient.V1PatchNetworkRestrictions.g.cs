...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1PatchNetworkRestrictionsSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1PatchNetworkRestrictionsSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1PatchNetworkRestrictionsSecurityRequirement0,
            };
        partial void PrepareV1PatchNetworkRestrictionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.NetworkRestrictionsPatchRequest request);
        partial void PrepareV1PatchNetworkRestrictionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.NetworkRestrictionsPatchRequest request);
        partial void ProcessV1PatchNetworkRestrictionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1PatchNetworkRestrictionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1PatchNetworkRestrictionsArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1PatchNetworkRestrictionsSecurityRequirements,
                operationName: "V1PatchNetworkRestrictionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1PatchNetworkRestrictionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1PatchNetworkRestrictions",
                                methodName: "V1PatchNetworkRestrictionsAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/network-restrictions\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1PatchNetworkRestrictionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1PatchNetworkRestrictionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.NetworkRestrictionsV2Response.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.NetworkRestrictionsV2Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.NetworkRestrictionsV2Response> V1PatchNetworkRestrictionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.NetworkRestrictionsPatchRequest
            {
                Add = add,
                Remove = remove,
            };

            return await V1PatchNetworkRestrictionsAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
