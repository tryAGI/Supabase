...
namespace Supabase
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Supabase.AutoSDKRetryOptions Retry { get; set; } = new global::Supabase.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Supabase.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Supabase.IAutoSDKHook>();
        ...
        public global::Supabase.AutoSDKClientOptions AddHook(
            global::Supabase.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Supabase.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Supabase.AutoSDKClientOptions UseAuthorizationProvider(
            global::Supabase.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Supabase.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Supabase.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Supabase.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Supabase.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Supabase.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Supabase.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Supabase.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Supabase.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Supabase.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Supabase.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Supabase.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Supabase.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Supabase.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Supabase.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Supabase.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Supabase.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Supabase.AutoSDKClientOptions clientOptions,
            global::Supabase.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Supabase.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Supabase.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Supabase.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Supabase.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Supabase.IAutoSDKHook, global::Supabase.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Supabase.AutoSDKHookContext context)
        {
