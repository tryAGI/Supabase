...
namespace Supabase
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1CreateAnOrganizationSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1CreateAnOrganizationSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1CreateAnOrganizationSecurityRequirement0,
            };
        partial void PrepareV1CreateAnOrganizationArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Supabase.CreateOrganizationV1 request);
        partial void PrepareV1CreateAnOrganizationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Supabase.CreateOrganizationV1 request);
        partial void ProcessV1CreateAnOrganizationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1CreateAnOrganizationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1CreateAnOrganizationArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1CreateAnOrganizationSecurityRequirements,
                operationName: "V1CreateAnOrganizationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CreateAnOrganizationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CreateAnOrganization",
                                methodName: "V1CreateAnOrganizationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CreateAnOrganizationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1CreateAnOrganizationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.OrganizationResponseV1.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.OrganizationResponseV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.OrganizationResponseV1> V1CreateAnOrganizationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.CreateOrganizationV1
            {
                Name = name,
            };

            return await V1CreateAnOrganizationAsync(
                request: __request,
                requestOptions: requestOptions,
