...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1InviteExternalJitAccessSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1InviteExternalJitAccessSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1InviteExternalJitAccessSecurityRequirement0,
            };
        partial void PrepareV1InviteExternalJitAccessArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.InviteExternalUserJitAccessBody request);
        partial void PrepareV1InviteExternalJitAccessRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.InviteExternalUserJitAccessBody request);
        partial void ProcessV1InviteExternalJitAccessResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1InviteExternalJitAccessResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await V1InviteExternalJitAccessAsResponseAsync(
                @ref: @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1InviteExternalJitAccessArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1InviteExternalJitAccessSecurityRequirements,
                operationName: "V1InviteExternalJitAccessAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1InviteExternalJitAccessRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1InviteExternalJitAccess",
                                methodName: "V1InviteExternalJitAccessAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/database/jit/invite\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1InviteExternalJitAccessResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1InviteExternalJitAccessResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.InviteExternalUserJitResponse> V1InviteExternalJitAccessAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.InviteExternalUserJitAccessBody
            {
                Email = email,
                Roles = roles,
            };

            return await V1InviteExternalJitAccessAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
