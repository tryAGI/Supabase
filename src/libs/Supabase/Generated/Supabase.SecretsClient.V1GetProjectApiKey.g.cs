...
namespace Supabase
{
    public partial class SecretsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1GetProjectApiKeySecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1GetProjectApiKeySecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1GetProjectApiKeySecurityRequirement0,
            };
        partial void PrepareV1GetProjectApiKeyArguments(
        ...
        partial void ProcessV1GetProjectApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1GetProjectApiKeyAsync(
            string @ref,
            global::System.Guid id,
        ...
        {
            var __response = await V1GetProjectApiKeyAsResponseAsync(
                @ref: @ref,
                id: id,
                reveal: reveal,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.ApiKeyResponseOutput>> V1GetProjectApiKeyAsResponseAsync(
            string @ref,
            global::System.Guid id,
            string? reveal = default,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1GetProjectApiKeyArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1GetProjectApiKeySecurityRequirements,
                operationName: "V1GetProjectApiKeyAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1GetProjectApiKey",
                                methodName: "V1GetProjectApiKeyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1GetProjectApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1GetProjectApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
