...
namespace Supabase
{
    ...
    public sealed partial class StorageConfigResponseOutputFeaturesVectorBuckets
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageConfigResponseOutputFeaturesVectorBuckets" /> class.
        /// </summary>
...
#endif
        public StorageConfigResponseOutputFeaturesVectorBuckets(
            bool enabled,
            long maxBuckets,
            long maxIndexes)
        {
