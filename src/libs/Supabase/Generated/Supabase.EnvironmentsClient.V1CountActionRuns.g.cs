...
namespace Supabase
{
    public partial class EnvironmentsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1CountActionRunsSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1CountActionRunsSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1CountActionRunsSecurityRequirement0,
            };
        partial void PrepareV1CountActionRunsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref);
        partial void PrepareV1CountActionRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref);
        partial void ProcessV1CountActionRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await V1CountActionRunsAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse> V1CountActionRunsAsResponseAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1CountActionRunsArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1CountActionRunsSecurityRequirements,
                operationName: "V1CountActionRunsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CountActionRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CountActionRuns",
                                methodName: "V1CountActionRunsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CountActionRunsResponse(
                    httpClient: HttpClient,
