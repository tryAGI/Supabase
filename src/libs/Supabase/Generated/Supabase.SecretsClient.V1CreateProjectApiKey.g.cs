...
namespace Supabase
{
    public partial class SecretsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1CreateProjectApiKeySecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1CreateProjectApiKeySecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1CreateProjectApiKeySecurityRequirement0,
            };
        ...
        partial void ProcessV1CreateProjectApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1CreateProjectApiKeyAsync(
            string @ref,
        ...
        {
            var __response = await V1CreateProjectApiKeyAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.ApiKeyResponseOutput>> V1CreateProjectApiKeyAsResponseAsync(
            string @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1CreateProjectApiKeyArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1CreateProjectApiKeySecurityRequirements,
                operationName: "V1CreateProjectApiKeyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CreateProjectApiKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CreateProjectApiKey",
                                methodName: "V1CreateProjectApiKeyAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/api-keys\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CreateProjectApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1CreateProjectApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ApiKeyResponseOutput> V1CreateProjectApiKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.CreateApiKeyBody
            {
                Type = type,
                Name = name,
            ...
            return await V1CreateProjectApiKeyAsync(
                @ref: @ref,
                reveal: reveal,
                request: __request,
                requestOptions: requestOptions,
