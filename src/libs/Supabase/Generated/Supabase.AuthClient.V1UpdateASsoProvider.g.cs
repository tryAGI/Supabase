...
namespace Supabase
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdateASsoProviderSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdateASsoProviderSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdateASsoProviderSecurityRequirement0,
            };
        partial void PrepareV1UpdateASsoProviderArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            ref global::System.Guid providerId,
            global::Supabase.UpdateProviderBody request);
        partial void PrepareV1UpdateASsoProviderRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::System.Guid providerId,
            global::Supabase.UpdateProviderBody request);
        partial void ProcessV1UpdateASsoProviderResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpdateASsoProviderResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdateASsoProviderArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdateASsoProviderSecurityRequirements,
                operationName: "V1UpdateASsoProviderAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdateASsoProvider",
                                methodName: "V1UpdateASsoProviderAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdateASsoProviderResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdateASsoProviderResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Supabase.UpdateProviderResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Supabase.UpdateProviderResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.UpdateProviderResponse> V1UpdateASsoProviderAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.UpdateProviderBody
            {
            ...
            return await V1UpdateASsoProviderAsync(
                @ref: @ref,
                providerId: providerId,
                request: __request,
                requestOptions: requestOptions,
