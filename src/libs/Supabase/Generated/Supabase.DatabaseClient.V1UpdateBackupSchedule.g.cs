...
namespace Supabase
{
    public partial class DatabaseClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1UpdateBackupScheduleSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1UpdateBackupScheduleSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1UpdateBackupScheduleSecurityRequirement0,
            };
        partial void PrepareV1UpdateBackupScheduleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.V1UpdateBackupScheduleBody request);
        partial void PrepareV1UpdateBackupScheduleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.V1UpdateBackupScheduleBody request);
        partial void ProcessV1UpdateBackupScheduleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1UpdateBackupScheduleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await V1UpdateBackupScheduleAsResponseAsync(
                @ref: @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1UpdateBackupScheduleArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1UpdateBackupScheduleSecurityRequirements,
                operationName: "V1UpdateBackupScheduleAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1UpdateBackupScheduleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1UpdateBackupSchedule",
                                methodName: "V1UpdateBackupScheduleAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1UpdateBackupScheduleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1UpdateBackupScheduleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.V1BackupScheduleResponse> V1UpdateBackupScheduleAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.V1UpdateBackupScheduleBody
            {
                ScheduleFor = scheduleFor,
            };

            return await V1UpdateBackupScheduleAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
