...
namespace Supabase
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1CreateLegacySigningKeySecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1CreateLegacySigningKeySecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1CreateLegacySigningKeySecurityRequirement0,
            };
        partial void PrepareV1CreateLegacySigningKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref);
        partial void PrepareV1CreateLegacySigningKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref);
        partial void ProcessV1CreateLegacySigningKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1CreateLegacySigningKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.SigningKeyResponseOutput> V1CreateLegacySigningKeyAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1CreateLegacySigningKeyAsResponseAsync(
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.SigningKeyResponseOutput>> V1CreateLegacySigningKeyAsResponseAsync(
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1CreateLegacySigningKeyArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1CreateLegacySigningKeySecurityRequirements,
                operationName: "V1CreateLegacySigningKeyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CreateLegacySigningKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CreateLegacySigningKey",
                                methodName: "V1CreateLegacySigningKeyAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/config/auth/signing-keys/legacy\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CreateLegacySigningKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1CreateLegacySigningKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
