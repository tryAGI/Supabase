...
namespace Supabase
{
    public partial class DomainsClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1ActivateVanitySubdomainConfigSecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1ActivateVanitySubdomainConfigSecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1ActivateVanitySubdomainConfigSecurityRequirement0,
            };
        partial void PrepareV1ActivateVanitySubdomainConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @ref,
            global::Supabase.VanitySubdomainBody request);
        partial void PrepareV1ActivateVanitySubdomainConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.VanitySubdomainBody request);
        partial void ProcessV1ActivateVanitySubdomainConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1ActivateVanitySubdomainConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await V1ActivateVanitySubdomainConfigAsResponseAsync(
                @ref: @ref,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1ActivateVanitySubdomainConfigArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ActivateVanitySubdomainConfigSecurityRequirements,
                operationName: "V1ActivateVanitySubdomainConfigAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1ActivateVanitySubdomainConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ActivateVanitySubdomainConfig",
                                methodName: "V1ActivateVanitySubdomainConfigAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/vanity-subdomain/activate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1ActivateVanitySubdomainConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1ActivateVanitySubdomainConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await V1ActivateVanitySubdomainConfigAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
