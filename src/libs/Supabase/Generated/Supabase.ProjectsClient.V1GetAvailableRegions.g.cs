...
namespace Supabase
{
    public partial class ProjectsClient
    {
        ...
        {
            var __response = await V1GetAvailableRegionsAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1GetAvailableRegions",
                                methodName: "V1GetAvailableRegionsAsync",
                                pathTemplate: "\"/v1/projects/available-regions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
