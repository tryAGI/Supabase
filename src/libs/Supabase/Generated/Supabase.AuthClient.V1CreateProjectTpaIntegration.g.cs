...
namespace Supabase
{
    public partial class AuthClient
    {
        ...
        partial void PrepareV1CreateProjectTpaIntegrationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @ref,
            global::Supabase.CreateThirdPartyAuthBody request);
        partial void ProcessV1CreateProjectTpaIntegrationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1CreateProjectTpaIntegrationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1CreateProjectTpaIntegrationArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1CreateProjectTpaIntegrationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1CreateProjectTpaIntegration",
                                methodName: "V1CreateProjectTpaIntegrationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1CreateProjectTpaIntegrationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1CreateProjectTpaIntegrationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.ThirdPartyAuth> V1CreateProjectTpaIntegrationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Supabase.CreateThirdPartyAuthBody
            {
            ...
            return await V1CreateProjectTpaIntegrationAsync(
                @ref: @ref,
                request: __request,
                requestOptions: requestOptions,
