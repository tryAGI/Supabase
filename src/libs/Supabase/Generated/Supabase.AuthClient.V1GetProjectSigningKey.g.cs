...
namespace Supabase
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement s_V1GetProjectSigningKeySecurityRequirement0 =
        ...
        private static readonly global::Supabase.EndPointSecurityRequirement[] s_V1GetProjectSigningKeySecurityRequirements =
            new global::Supabase.EndPointSecurityRequirement[]
            {                s_V1GetProjectSigningKeySecurityRequirement0,
            };
        partial void PrepareV1GetProjectSigningKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string @ref);
        partial void PrepareV1GetProjectSigningKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            string @ref);
        partial void ProcessV1GetProjectSigningKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1GetProjectSigningKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Supabase.SigningKeyResponseOutput> V1GetProjectSigningKeyAsync(
            global::System.Guid id,
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1GetProjectSigningKeyAsResponseAsync(
                id: id,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Supabase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Supabase.AutoSDKHttpResponse<global::Supabase.SigningKeyResponseOutput>> V1GetProjectSigningKeyAsResponseAsync(
            global::System.Guid id,
            string @ref,
            global::Supabase.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1GetProjectSigningKeyArguments(
            ...
            var __authorizations = global::Supabase.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1GetProjectSigningKeySecurityRequirements,
                operationName: "V1GetProjectSigningKeyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1GetProjectSigningKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Supabase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1GetProjectSigningKey",
                                methodName: "V1GetProjectSigningKeyAsync",
                                pathTemplate: "$\"/v1/projects/{@ref}/config/auth/signing-keys/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1GetProjectSigningKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Supabase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1GetProjectSigningKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
